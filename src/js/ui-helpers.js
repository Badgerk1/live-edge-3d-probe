...
function _buildSubdividedFaceGrid(results, resolution) {
  ...
  for (var ri = 0; ri < numRows; ri++) {
    ...
    // Fit a not-a-knot cubic spline along X — avoids the artificial flattening
    // at the edges that natural BCs produce with only 5 sparse probe columns.
    var xSplineY = _buildNotAKnotCubicSpline(xs, rowYatCols);
