...
async function runOutlineSurfaceGridProbe() {
  ...
  try {
    ...
    var clearanceZ = cfg.clearZ;
    var maxPlunge  = cfg.probeDown;
    ...
    outlineAppendLog('Settings: clearanceZ=' + clearanceZ + ' maxPlunge=' + maxPlunge +
    ...
    for (var row = 0; row < gridCfg.rowCount; row++) {
      ...
      if (row + 1 < gridCfg.rowCount) {
        ...
        await smSafeLateralMove(nextStartX, nextY, travelFeed, clearanceZ);
        await smEnsureProbeClear(clearanceZ, travelFeed);
      }
    }
