...
// Each triangle's face normal is computed from the vertex positions so Aspire
// does not have to rely on vertex-normal hints.
function _stlDownload(verts, tris, filename) {
  if (!tris.length) return;
  var buf = new ArrayBuffer(84 + 50 * tris.length);
